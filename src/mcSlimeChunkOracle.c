...
*/
int64_t getMCSeed(int64_t seed, int32_t chunkX, int32_t chunkZ){
  return seed + chunkX * chunkX * 0x4c1906 + chunkX * 0x5ac0db + chunkZ * chunkZ * 0x4307a7LL + chunkZ * 0x5f24f ^ 0x3ad8025f;
}
...
*/
bool isSlimeChunk(Random* rnd, int64_t seed, int32_t x, int32_t z){
  setSeed(rnd, getMCSeed(seed, x, z));
  //return nextIntWithRange(rnd, 10) == 0;
  return !nextIntWithRange(rnd, 10);
}
